<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('diseasemedicine.index')" :active="request()->routeIs('diseasemedicine.index')">
                    ...
                    @if(Auth::check() && Auth::user()->role === 'admin')
                        <x-nav-link href="http://127.0.0.1:8000/adminPanel/" :active="request()->is('adminPanel/*')">
                            {{ __('Admin') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('diseasemedicine.index')" :active="request()->routeIs('diseasemedicine.index')">
                {{ __('Diseases & Medicines') }}
            </x-responsive-nav-link>
